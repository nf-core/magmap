...
it can be called with `--indexed`option and it is a path (local or remote it doesn't matter).
...
The pipeline uses [Prokka](https://github.com/tseemann/prokka) to call genes/ORFs from the genomes. This is suitable for prokaryotes and it provides a gff as output for downdream analysis. It also performs functional annotation of ORFs.
