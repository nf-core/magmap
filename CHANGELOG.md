...
- [#257](https://github.com/nf-core/magmap/pull/257) - Add `proteins/magmap.proteins.faa.gz`, a protein FASTA of all selected genomes, translating CDSs with gffread for genomes that come with a gff file, closes [#236](https://github.com/nf-core/magmap/issues/236) (by @erikrikarddaniel).
...
- [#NN](https://github.com/nf-core/magmap/pull/NN) - Reject `--genomeinfo` accessions ending in a FASTA extension, which made Prokka fail, and stop at startup if a genome is missing from `--gtdbtk_metadata`/`--checkm_metadata`; FASTA extensions in those files' identifiers are now ignored, closes [#260](https://github.com/nf-core/magmap/issues/260) (by @erikrikarddaniel).
